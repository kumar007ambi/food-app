    ...
    <header className="fixed top-0 z-[1000] w-full h-[80px] bg-white px-5 shadow-[0_15px_40px_-20px_rgba(40,44,63,0.15)]">
      <div className="h-full min-w-[1200px] max-w-[1200px] flex mx-auto">
        ...
        <ul className="flex flex-1 justify-end items-center h-full text-sm">
          ...
          <li className={`mr-[60px] font-semibold  "text-[#fc8019]"} hover:text-[#fc8019] group`}>
            <Link className="flex" >
              <span className="mr-2.5">
                <svg className={`fill-[#3d4152] "fill-[#fc8019]"} group-hover:fill-[#fc8019]`} viewBox="0 0 32 32" height="19" width="19" fill="#686b78">
          ...
          <li className={`last:mr-0 font-semibold  "text-[#fc8019]"} hover:text-[#fc8019] group`}>
            <Link className="flex" to="/cart">
              <span className="mr-2.5 flex relative">
                <svg className={`fill-[#60b246] group-hover:fill-[#fc8019] "fill-[#fc8019] stroke-[#fc8019]"} group-hover:stroke-[#fc8019] stroke-[#60b246]`} viewBox="-1 0 37 32" height="20" width="22" fill="#686b78">
